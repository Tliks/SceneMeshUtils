...
public class LocalizationEditor
{
    ...
    private static Dictionary<string, string[]> _LocalizedText = new Dictionary<string, string[]>
    {
        ...
        { "mask.color", new string[] {"Selected:Background color", "選択:背景 色"}},
        { "mask.color.white:black", new string[] {"white:black", "白:黒"}},
        { "mask.color.black:white", new string[] {"black:white", "黒:白"}},
        { "mask.color.original:black", new string[] {"original:black", "オリジナル:黒"}},
        { "mask.color.original:alpha", new string[] {"original:alpha", "オリジナル:アルファ"}},

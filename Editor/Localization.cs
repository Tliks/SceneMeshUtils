...
public class LocalizationEditor
{
    ...
    private static Dictionary<string, string[]> _LocalizedText = new Dictionary<string, string[]>
    {
        ...
        { "RenameRootTransformToggle", new string[] { "Rename RootTransform", "RootTransform名変更" } },
        { "SpecifyRootObjectLabel", new string[] { "Specify Root Object", "ルートオブジェクト指定" } },
        { "EncodedIslandsLabel", new string[] { "Encoded Selection:", "エンコードされた選択:" } },

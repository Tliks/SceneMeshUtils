...
namespace com.aoyon.scenemeshutils
{
    internal class RemoveMeshFromScenePreview : IRenderFilter
    {
        ...
        {
            var node = new RemoveMeshFromScenePreviewNode();
    ...
    internal class RemoveMeshFromScenePreviewNode : IRenderFilterNode
    {
        ...
        public bool Initialize(RenderGroup group, IEnumerable<(Renderer, Renderer)> proxyPairs, ComputeContext context)
        {
            ...
            _modifiedMesh = MeshUtility.DeleteMesh(proxy.sharedMesh, _component.triangleSelection.ToHashSet());
